...
public class HouseScripts extends Script {
    ...
    public void buildscript_v_1_2() {
        ...
        Block[][][] blocks = GeneratorUtils.prepareScriptSession(localSession, actor, getPlayer(), weWorld, 10, true, true,
                false);

        if (blocks == null) {
            getPlayer().sendMessage("§c§lERROR: §cRegion not readable. Please report this to the developers of the " +
                    "BuildTeamTool plugin.");
            return;
        }
        ...
        for (XMaterial wool : woolColorsNoYellow) {
            replaceBlocksWithMask("=queryRel(1,0,0,45,0)||queryRel(-1,0,0,45,0)||queryRel(0,0,1,45,0)||queryRel(0,0,-1,45,0)" +
                            "||queryRel(1,0,1,45,0)||queryRel(-1,0,1,45,0)||queryRel(1,0,-1,45,0)||queryRel(-1,0,-1,45,0)",
                    wool, XMaterial.SPONGE);

            replaceBlocksWithMask("=queryRel(1,0,0,19,0)||queryRel(-1,0,0,19,0)||queryRel(0,0,1,19,0)||queryRel(0,0,-1,19,0)" +
                            "||queryRel(1,0,1,19,0)||queryRel(-1,0,1,19,0)||queryRel(1,0,-1,19,0)||queryRel(-1,0,-1,19,0)",
        ...
        replaceBlocksWithMask("=(queryRel(0,1,0,0,0)||queryRel(0,1,0,35,11)||queryRel(0,1,0,35,14)||queryRel(0,1,0,35,5)" +
                        "||queryRel(0,1,0,35,4))"
        ...
        setBlocksWithMask("=queryRel(0,-1,0,45,0)" +
                        "&&(queryRel(1,0,0,35,11)||queryRel(-1,0,0,35,11)||queryRel(0,0,1,35,11)||queryRel(0,0,-1,35,11)" +
                        "||queryRel(1,0,1,35,11)||queryRel(-1,0,-1,35,11)||queryRel(-1,0,1,35,11)||queryRel(1,0,-1,35,11))" +
                        "&&!(queryRel(1,0,0,35,5)||queryRel(-1,0,0,35,5)||queryRel(0,0,1,35,5)||queryRel(0,0,-1,35,5)||queryRel" +
                        "(1,0,1,35,5)||queryRel(-1,0,-1,35,5)||queryRel(-1,0,1,35,5)||queryRel(1,0,-1,35,5))",
                XMaterial.BLUE_WOOL, 20);


        // Place the last blue wool between the lime wool and the blue wool
        setBlocksWithMask("=queryRel(0,-1,0,45,0)&&(queryRel(1,0,0,35,11)||queryRel(-1,0,0,35,11)||queryRel(0,0,1,35,11)" +
                        "||queryRel(0,0,-1,35,11)||queryRel(1,0,1,35,11)||queryRel(-1,0,-1,35,11)||queryRel(-1,0,1,35,11)" +
                        "||queryRel(1,0,-1,35,11))",
                XMaterial.BLUE_WOOL);
        ...
        setBlocksWithMask("=!queryRel(0,0,0,45,0)&&(queryRel(-1,0,0,35,4)||queryRel(1,0,0,35,4)||queryRel(0,0,1,35,4)||queryRel" +
                        "(0,0,-1,35,4))",
        ...
        for (int i = 0; i < floorCount; i++) {
            ...
            for (int i2 = 0; i2 < windowHeight; i2++) {
                ...
                if (!containsRedWool) {
                    ...
                    replaceBlocksWithMask("=queryRel(0," + (-currentHeight) + ",0,45,-1)", XMaterial.RED_WOOL,
                    ...
                    replaceBlocksWithMask("=queryRel(0," + (-currentHeight) + ",0,45,-1)", XMaterial.LAPIS_ORE,
                            XMaterial.LAPIS_ORE);

                    // Replace lime wool with lapislazuli ore
                    replaceBlocksWithMask("=queryRel(0," + (-currentHeight) + ",0,45,-1)", XMaterial.LIME_WOOL,
                            XMaterial.LAPIS_ORE);
                }
        ...
        queries = new String[]{
                // Any white glass block whose z%6 remainder > 1, and which has air in the x+1 direction, and has no air in the
                // x-1 direction, and has no white glass in the x-1 direction, is replaced with gray glass.
                ...
                // Any white glass block whose x%6 remainder > 1, and which has air in the z+1 direction, and has no air in the
                // z-1 direction, and has no white glass in the z-1 direction, is replaced with gray glass.
        ...
        if (containsOrangeWool) {
            ...
            setBlocksWithMask("=queryRel(0,-1,0,35,13)&&(queryRel(-1,-1,0,0,0)||queryRel(1,-1,0,0,0)||queryRel(0,-1,-1,0,0)" +
                            "||queryRel(0,-1,1,0,0))",
                    balconyFenceColor);
        ...
        if (roofType == RoofType.FLATTER_SLABS || roofType == RoofType.STEEP_SLABS || roofType == RoofType.MEDIUM_SLABS) {
            ...
            replaceBlocksWithMask("=queryRel(1,0,0,35,5)||queryRel(-1,0,0,35,5)||queryRel(0,0,1,35,5)||queryRel(0,0,-1,35,5)" +
                            "||queryRel(1,0,1,35,5)||queryRel(-1,0,-1,35,5)||queryRel(-1,0,1,35,5)||queryRel(1,0,-1,35,5)",
            ...
            for (int i = 0; i < maxRoofHeight; i++) {
                ...
                replaceBlocksWithMask("=queryRel(0,-1,0,35,11)&&" +
                                "(" +
                                "queryRel(1,-1,0,35,5)||queryRel(-1,-1,0,35,5)||queryRel(0,-1,1,35,5)||queryRel(0,-1,-1,35,5)" +
                                "||queryRel(1,-1,1,35,5)||queryRel(-1,-1,-1,35,5)||queryRel(-1,-1,1,35,5)||queryRel(1,-1,-1,35," +
                                "5)" +
                                ")",
                        XMaterial.BLUE_WOOL, XMaterial.LIME_WOOL);
                ...
                replaceBlocksWithMask("=queryRel(0,-1,0,35,11)&&" +
                                "(" +
                                "queryRel(1,0,0,35,5)||queryRel(-1,0,0,35,5)||queryRel(0,0,1,35,5)||queryRel(0,0,-1,35,5)" +
                                "||queryRel(1,0,1,35,5)||queryRel(-1,0,-1,35,5)||queryRel(-1,0,1,35,5)||queryRel(1,0,-1,35,5)" +
                                ")",
                        XMaterial.BLUE_WOOL, XMaterial.LIME_WOOL);
            ...
            // (First Roof Layer) Select only air blocks that are next to yellow wool in any direction and above lapislazuli
            // ore. Then replace them with stone slabs
            replaceBlocksWithMask("=queryRel(0,-1,0,21,0)&&queryRel(0,0,0,0,0)&&(queryRel(1,0,0,35,4)||queryRel(1,0,0,35,4)" +
                            "||queryRel(-1,0,0,35,4)||queryRel(0,0,1,35,4)||queryRel(0,0,-1,35,4))",
                    XMaterial.LAPIS_ORE, XMaterial.STONE_SLAB);

            // (Fix First Roof Layer) Select only air blocks that are next to stone slabs and lime wool in any direction and
            // above lapislazuli ore. Then replace them with stone slabs
            replaceBlocksWithMask("=queryRel(0,-1,0,21,0)&&queryRel(0,0,0,0,0)&&(queryRel(1,0,0,44,0)||queryRel(-1,0,0,44,0)" +
                            "||queryRel(0,0,1,44,0)||queryRel(0,0,-1,44,0))",
                    XMaterial.LAPIS_ORE, XMaterial.STONE_SLAB, 2);

            // (Overhang Roof Layer 1) Select all air blocks next to lapislazuli ores that have a stone slab above them. Then
            // replace them with and upside down stone slab
            ...
            // (Overhang Roof Layer 2) Select all air blocks next to upside down stone slab and lapislazuli. Then replace them
            // with and upside down stone slab
            setBlocksWithMask("=queryRel(0,0,0,0,0)&&" +
                            "(" +
            ...
            if (maxRoofHeight > 0)
                for (int i = 0; i < maxRoofHeight; i++) {
                    if (roofType == RoofType.FLATTER_SLABS || roofType == RoofType.MEDIUM_SLABS)
                        //Only select air block that are surrounded by other stone slabs below or which are directly neighbors
                        // to lime wool or blue wool
                        replaceBlocksWithMask("=queryRel(0,-1,0,43,0)&&" +
                                        "(" +
                                        "(" +
                                        "queryRel(1,-1,0,43,-1)&&queryRel(-1,-1,0,43,-1)&&queryRel(0,-1,1,43,-1)&&queryRel(0," +
                                        "-1,-1,43,-1)" +
                        ...
                        replaceBlocksWithMask("=!(queryRel(1,-1,0,44,-1)||queryRel(-1,-1,0,44,-1)||queryRel(0,-1,1,44,-1)" +
                                        "||queryRel(0,-1,-1,44,-1))",
                                getSlab(BlockTypes.STONE_SLAB, "double"), getSlab(BlockTypes.STONE_SLAB, "bottom"));
                    ...
                    if (roofType == RoofType.FLATTER_SLABS)
                        ...
                        //Only select air block that are surrounded by other stone slabs or which are directly neighbors to
                        // lime wool or blue wool
                        replaceBlocksWithMask(
                                "(" +
                                        "queryRel(1,0,0,44,-1)&&queryRel(-1,0,0,44,-1)&&queryRel(0,0,1,44,-1)&&queryRel(0,0,-1," +
                                        "44,-1)" +
                        ...
                        replaceBlocksWithMask("=!(queryRel(1,0,0,0,-1)||queryRel(-1,0,0,0,-1)||queryRel(0,0,1,0,-1)||queryRel" +
                                        "(0,0,-1,0,-1))"
                                , getSlab(BlockTypes.STONE_SLAB, "bottom"), getSlab(BlockTypes.STONE_SLAB, "double"));
                }
            ...
            // (Overhang Roof Layer 3) Select all air blocks next to two upside down stone slabs. Then replace them with and
            // upside down stone slab
            replaceBlocksWithMask("=(queryRel(1,0,0,44,8)&&queryRel(2,0,0,44,8))||(queryRel(-1,0,0,44,8)&&queryRel(-2,0,0,44,8)" +
                            ")||(queryRel(0,0,1,44,8)&&queryRel(0,0,2,44,8))||(queryRel(0,0,-1,44,8)&&queryRel(0,0,-2,44,8))",
            ...
            replaceBlocksWithMask("=queryRel(1,-1,0,35,5)||queryRel(-1,-1,0,35,5)||queryRel(0,-1,1,35,5)||queryRel(0,-1,-1,35," +
                            "5)||queryRel(1,-1,1,35,5)||queryRel(-1,-1,-1,35,5)||queryRel(-1,-1,1,35,5)||queryRel(1,-1,-1,35,5)",
            ...
            replaceBlocksWithMask("=queryRel(1,-1,0,44,8)||queryRel(-1,-1,0,44,8)||queryRel(0,-1,1,44,8)||queryRel(0,-1,-1,44," +
                            "8)||queryRel(1,-1,1,44,8)||queryRel(-1,-1,-1,44,8)||queryRel(-1,-1,1,44,8)||queryRel(1,-1,-1,44,8)",
                    XMaterial.LIME_WOOL, XMaterial.STONE_SLAB);


            // Select all air blocks that are below & next to lime wool and under a stone slab and replace it with upside down
            // stone slabs
            replaceBlocksWithMask("=queryRel(0,1,0,44,0)&&(queryRel(1,1,0,35,5)||queryRel(-1,1,0,35,5)||queryRel(0,1,1,35,5)" +
                            "||queryRel(0,1,-1,35,5)||queryRel(1,1,1,35,5)||queryRel(-1,1,-1,35,5)||queryRel(-1,1,1,35,5)" +
                            "||queryRel(1,1,-1,35,5))",
                    getAir(), getSlab(BlockTypes.STONE_SLAB, "top"));

            // Select all air blocks that are next to lime wool and under a stone slab and replace it with upside down stone slabs
            replaceBlocksWithMask("=queryRel(0,1,0,44,0)&&(queryRel(1,0,0,35,5)||queryRel(-1,0,0,35,5)||queryRel(0,0,1,35,5)" +
                            "||queryRel(0,0,-1,35,5))",
                    getAir(), getSlab(BlockTypes.STONE_SLAB, "top"));
            ...
            // (First Roof Layer) Select only air blocks that are next to yellow wool in any direction and above lapislazuli
            // ore. Then replace them with stone bricks
            setBlocksWithMask("=queryRel(0,-1,0,21,0)&&queryRel(0,0,0,0,0)&&(queryRel(1,0,0,35,4)||queryRel(1,0,0,35,4)" +
                            "||queryRel(-1,0,0,35,4)||queryRel(0,0,1,35,4)||queryRel(0,0,-1,35,4))",
                    XMaterial.STONE_BRICKS);

            // (Fix First Roof Layer) Select only air blocks that are next to stone slabs in any direction and above
            // lapislazuli ore. Then replace them with stone bricks
            setBlocksWithMask("=queryRel(0,-1,0,21,0)&&queryRel(0,0,0,0,0)&&(queryRel(1,0,0,98,0)||queryRel(1,0,0,98,0)" +
                            "||queryRel(-1,0,0,98,0)||queryRel(0,0,1,98,0)||queryRel(0,0,-1,98,0))",
            ...
            // (Overhang Roof Layer) Select all air blocks next to lapislazuli ores that have sponge above them. Then replace
            // them with stone bricks
            ...
            replaceBlocksWithMask("=(queryRel(1,0,0,19,0)&&queryRel(2,0,0,21,0))||(queryRel(-1,0,0,19,0)&&queryRel(-2,0,0,21,0)" +
                            ")||(queryRel(0,0,1,19,0)&&queryRel(0,0,2,21,0))||(queryRel(0,0,-1,19,0)&&queryRel(0,0,-2,21,0))",
            ...
            if (maxRoofHeight > 0)
                for (int i = 0; i < maxRoofHeight; i++) {
                    ...
                    if (i % 2 == 0)
                        ...
                        setBlocksWithMask("=queryRel(0,-1,0,35,4)&&(queryRel(1,-1,0,98,-1)||queryRel(-1,-1,0,98,-1)||queryRel" +
                                        "(0,-1,1,98,-1)||queryRel(0,-1,-1,98,-1))",
                                XMaterial.STONE_BRICKS);
                    else
                        // Only select air block that have yellow wool below them which are completely surrounded by other
                        // stone bricks
                        setBlocksWithMask("=queryRel(0,-1,0,35,4)&&(queryRel(1,-1,0,98,-1)||queryRel(-1,-1,0,98,-1)||queryRel" +
                                        "(0,-1,1,98,-1)||queryRel(0,-1,-1,98,-1)||queryRel(1,-1,1,98,-1)||queryRel(-1,-1,1,98," +
                                        "-1)||queryRel(-1,-1,-1,98,-1)||queryRel(1,-1,-1,98,-1))",
                                XMaterial.STONE_BRICKS);
            ...
            queries = new String[]{
                    ...
                    "=queryRel(0,1,0,98,0)&&(queryRel(-1,0,0,98,0)||queryRel(-1,0,1,98,0)||queryRel(-1,0,-1,98,0))&&(queryRel" +
                            "(1,0,0,98,0)||queryRel(1,0,1,98,0)||queryRel(1,0,-1,98,0))",
                    "=queryRel(0,1,0,98,0)&&(queryRel(0,0,-1,98,0)||queryRel(1,0,-1,98,0)||queryRel(-1,0,-1,98,0))&&(queryRel" +
                            "(0,0,1,98,0)||queryRel(1,0,1,98,0)||queryRel(-1,0,1,98,0))"
            };
            ...
            // Fill the remaining overhang with upside-down stairs which are surrounded by 1 stone brick and one stone brick
            // above them
            ...
            // (Normal Stair Roof Layer) Replace all air blocks that have a stone brick on one side, 3 air sides and one stone
            // brick below them with stairs
            replaceBlocksWithMask("=queryRel(0,-1,0,98,0)&&(queryRel(1,0,0,98,-1)&&queryRel(-1,0,0,0,-1)&&queryRel(0,0,1,0,-1)" +
                            "&&queryRel(0,0,-1,0,-1))",
                    getAir(), getStair(BlockTypes.STONE_STAIRS, "east", "bottom", "straight"));
            replaceBlocksWithMask("=queryRel(0,-1,0,98,0)&&(queryRel(1,0,0,0,-1)&&queryRel(-1,0,0,98,-1)&&queryRel(0,0,1,0,-1)" +
                            "&&queryRel(0,0,-1,0,-1))",
                    getAir(), getStair(BlockTypes.STONE_STAIRS, "west", "bottom", "straight"));
            replaceBlocksWithMask("=queryRel(0,-1,0,98,0)&&(queryRel(1,0,0,0,-1)&&queryRel(-1,0,0,0,-1)&&queryRel(0,0,1,98,-1)" +
                            "&&queryRel(0,0,-1,0,-1))",
                    getAir(), getStair(BlockTypes.STONE_STAIRS, "south", "bottom", "straight"));
            replaceBlocksWithMask("=queryRel(0,-1,0,98,0)&&(queryRel(1,0,0,0,-1)&&queryRel(-1,0,0,0,-1)&&queryRel(0,0,1,0,-1)" +
                            "&&queryRel(0,0,-1,98,-1))",
                    getAir(), getStair(BlockTypes.STONE_STAIRS, "north", "bottom", "straight"));


            // (Corner Stair Roof Layer) Replace all air blocks that have stone bricks on 2 sides, 2 air or stair sides and one
            // stone brick below them with stairs
            replaceBlocksWithMask("=queryRel(0,-1,0,98,0)&&(queryRel(1,0,0,98,-1)&&queryRel(0,0,1,98,-1)&&(queryRel(-1,0,0,0," +
                            "-1)||queryRel(-1,0,0,109,-1))&&(queryRel(0,0,-1,0,-1)||queryRel(0,0,-1,109,-1)))",
            ...
            // (Corner Stair 2 Roof Layer) Replace all air blocks that have stairs on 2 sides, 2 air sides and one stone brick
            // below them with stairs
            replaceBlocksWithMask("=queryRel(0,-1,0,98,0)&&(queryRel(1,0,0,109,-1)&&queryRel(0,0,1,109,-1)&&queryRel(-1,0,0,0," +
                            "-1)&&queryRel(0,0,-1,0,-1))",
