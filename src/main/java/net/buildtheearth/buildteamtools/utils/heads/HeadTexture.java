...
public enum HeadTexture {
    ...
    public static ItemStack getLetterHead(char letter, LetterType letterType, String headName, ArrayList<String> lore) {
    ...
    public static ItemStack getWoodenLetterHead(char letter, String headName, ArrayList<String> lore) {
    ...
    public static ItemStack getStoneLetterHead(char letter, String headName, ArrayList<String> lore) {
        HeadTexture texture = switch (letter) {
