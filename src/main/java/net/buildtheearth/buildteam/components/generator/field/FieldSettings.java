...
public class FieldSettings extends Settings {
    ...
    public void setDefaultValues() {
        ...
        if (crop.equals(Crop.HARVESTED))
            cropStage = (CropStage) Utils.pickRandom(new CropStage[]{CropStage.DRY, CropStage.MUD});
        if (crop.equals(Crop.OTHER))
            cropStage = (CropStage) Utils.pickRandom(new CropStage[]{CropStage.DRIED_OUT, CropStage.OVERGROWN});
