        ...
        API.getAsync(url, new API.ApiResponseCallback() {
            ...
            public void onResponse(String response) {
                ...
                if (featuresArray == null || featuresArray.isEmpty()) {
                    future.completeExceptionally(new IllegalStateException("No location data found for these coordinates. The location may be in the ocean or outside mapped areas."));
                    return;
                }
